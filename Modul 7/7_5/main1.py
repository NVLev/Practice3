...
num_tunnus = int(input('Tunnuksen numero: '))
num_ser = int(input('Tunnuksen numero: '))
num_tunnus_num_ser = (num_tunnus, num_ser)
if num_tunnus_num_ser in data:
    print(data[num_tunnus_num_ser])
